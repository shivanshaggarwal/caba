    ...
    return (
        <div className="offset-2 col-7 p-0">
            <div className="row gy-2 m-0">
                ...
                <div className="col-md-3 p-1 text-start">
                    <input type="text" className={`form-control ${formik.errors.guardianMiddleName && formik.touched.guardianMiddleName ? "border-danger" : ""}`} id="guardianMiddleName" value={formik.values.guardianMiddleName} onChange={(e) => formik.setFieldValue('guardianMiddleName', e.target.value)} />
                    <label htmlFor="guardianMiddleName">Middle</label>
                </div>
                <div className="col-md-4 p-1 text-start">
                    <input type="text" className={`form-control ${formik.errors.guardianLastName && formik.touched.guardianLastName ? "border-danger" : ""}`} id="guardianLastName" value={formik.values.guardianLastName} onChange={(e) => formik.setFieldValue('guardianLastName', e.target.value)} />
                    <label htmlFor="guardianLastName">Last</label>
                </div>
            </div>
            {((formik.errors.guardianFirstName && formik.touched.guardianFirstName) || (formik.errors.guardianMiddleName && formik.touched.guardianMiddleName) || (formik.errors.guardianLastName && formik.touched.guardianLastName)) ? (

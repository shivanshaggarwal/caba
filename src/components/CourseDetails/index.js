            ...
            <div className="row courseDetails p-0">
                ...
                <div className="bg-secondary-subtle m-0 mt-1 mb-2 p-2">
                    <div className="row rollNumber m-0 mb-4">
                        <label htmlFor="rollNumber" className="text-start mb-2 ps-1 col-md-3"><b>Roll Number</b></label>
                    ...
                    <div className="row date m-0 mb-4">
                        <label htmlFor="dateOfJoining" className="text-start mb-2 ps-1 col-md-3"><b>Date Of Joining</b></label>
                        <div className="offset-md-2 col-md-7 p-0">
                    ...
                    <div className="row trainingType m-0 mb-4">
                        <label htmlFor="trainingType" className="text-start mb-2 ps-1 col-md-3"><b>Training Type</b></label>
                        <div className="offset-md-2 col-md-7 p-0">
                    ...
                    <div className="row courseOpted m-0 mb-4">
                        <label htmlFor="courseOpted" className="text-start mb-2 ps-1 col-md-3">
                            <b>Course Opted</b>
                        </label>
                        <div className="offset-md-2 col-md-7 p-0">
                    ...
                    <div className="row daysOpted m-0 mb-4">
                        <label htmlFor="daysOpted" className="text-start mb-2 ps-1 col-md-3"><b>Days Opted</b></label>
                        <div className="offset-md-2 col-md-7 p-0">
                    ...
                    <div className="row bacth m-0 mb-4">
                        <label htmlFor="batch" className="text-start mb-2 ps-1 col-md-3"><b>Batch</b></label>
                        <div className="offset-md-2 col-md-7 p-0">

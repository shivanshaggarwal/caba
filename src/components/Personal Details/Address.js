                ...
                <div className="col-12 mt-2 p-0">
                    <div className="row m-0 p-0 ">
                        ...
                        <div className="col-6 p-0">
                            ...
                            <select
                                className={`form-control ${formik.errors.country && formik.touched.country ? "border-danger" : ""}`} id="country" onBlur={formik.handleBlur('country')} value={formik.values.country} onChange={(e) => formik.setFieldValue('country', e.target.value)}
                            >

        ...
        <>
            <div className="row personalDetails">
                ...
                <div className="row photo m-0 mb-4">
                    <label htmlFor="photo" className="text-start col-12 col-sm-3"><b>Your Photo</b></label>
                ...
                <div className="row fullname m-0 mb-4">
                    <label htmlFor="fullName" className="text-start col-12 col-sm-3 ps-1">
                        <b>Full Name <span className='text-danger'>*</span></b>
                    </label>
                    <FullName formik={formik} />
                </div>
                <div className="row email m-0 mb-4">
                    <label htmlFor="photo" className="text-start col-12 mb-2 ps-1"><b>Email</b></label>
                ...
                <div className="row phone m-0 mb-4">
                    <label htmlFor="mobileNumber" className="text-start col-12 mb-2 ps-1"><b>Mobile</b></label>
                    <div className="col-12 p-0">
                        <div >
                ...
                <div className="row phone m-0 mb-4">
                    <label htmlFor="photo" className="text-start col-12 mb-2 ps-1"><b>Any Other Phone</b></label>
                    <div className="col-12 p-0">
                        <div >
                            <div className="input-group">
                                <button type="button" style={{ borderColor: '#dee2e6' }} className="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div className="row adhar m-0  mb-4">
                    <label htmlFor="photo" className="text-start col-12 mb-2 ps-1"><b>Self Aadhar</b></label>
                ...
                <div className="row tenth m-0 mb-4">
                    <label htmlFor="photo" className="text-start col-12 mb-2 ps-1"><b>10th Certificate</b></label>
                ...
                <div className="row twelth m-0  mb-4">
                    <label htmlFor="photo" className="text-start col-12 mb-2 ps-1"><b>12th Certificate</b></label>
                ...
                <div className="row graduation m-0  mb-4">
                    <label htmlFor="photo" className="text-start col-12 mb-2 ps-1"><b>Graduation Certificate</b></label>
                ...
                <div className="row address m-0  mb-4 g-3">
                    <label htmlFor="inputAddress" className="text-start col-12  ps-1"><b>Your Address</b></label>
                    <div className=' p-0'>
